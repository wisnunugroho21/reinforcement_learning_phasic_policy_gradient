...
class Agent():  
    ...
    # Loss for PPO  
    def get_policy_loss(self, action_probs, values, old_action_probs, old_values, next_values, actions, rewards, dones):
    ...
    def get_aux_loss(self, action_probs, values, old_action_probs, Returns):
        # Don't use old value in backpropagation
        Old_action_probs    = old_action_probs.detach()
    ...
    def training_ppo(self, states, actions, rewards, dones, next_states):
        ...
        loss                = self.get_policy_loss(action_probs, values, old_action_probs, old_values, next_values, actions, rewards, dones)
    ...
    def training_aux(self, states):
        ...
        joint_loss                      = self.get_aux_loss(action_probs, values, old_action_probs, Returns)
...
def main():
    ...
    learning_rate       = 5e-4 # Just set to 0.95
    ############################################# 
